var CartController = function () {
    ...
    function getColorOptions(selectedId) {
        var colors = "<select class='form-control ddlColorId' style='font-size: 14px;'> <option value = '0'></option>";
    ...
    function getSizeOptions(selectedId) {
        var sizes = "<select class='form-control ddlSizeId' style='font-size: 14px;'> <option value = '0'></option>";
